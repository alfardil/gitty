...
const globalSubscribers = new Set<(timeLeft: typeof globalTimeLeft) => void>();
...
function startGlobalTimer() {
  ...
  const calculateTimeLeft = () => {
    ...
    if (difference > 0) {
      ...
      if (
        globalTimeLeft.days !== newTimeLeft.days ||
      ...
      if (
        ...
        globalTimeLeft.hours !== 0 ||
        globalTimeLeft.minutes !== 0 ||
        globalTimeLeft.seconds !== 0
      ) {
